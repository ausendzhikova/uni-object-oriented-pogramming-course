...
public:
	PendulumCard(std::string name="", std::string effect="",unsigned int rarity=0, unsigned int attackPoints=0, unsigned int defencePoints=0, unsigned int pendulumScale=1, CardType type=CardType::UNKNOWN);
